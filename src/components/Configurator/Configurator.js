...
export default function Configurator(props) {
  ...
  let colorButton = useColorModeValue("#FF4546", "gray.700");
  const secondaryButtonBg = useColorModeValue("#FF4546", "transparent");
  const secondaryButtonBorder = useColorModeValue("gray.700", "#FF4546");
  const secondaryButtonColor = useColorModeValue("gray.700", "#FF4546");
